...
BOT_TOKEN = '7531183566:AAHjgKwM-kf-owsLOOAg6D6xhzMzMJqWIdU'
...
async def main():
    ...
    # Start checking for new links in an async loop
    await check_for_new_links(batch_chat_pairs)

if __name__ == "__main__":
    # Start Flask and the bot in the same event loop
